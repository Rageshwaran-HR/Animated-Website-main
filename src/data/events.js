...
export const EVENTS = [
  ...
  },
  {
    ...
    details: {
      ...
      contacts: [
        ...
        { role: "Student Coordinator", name: "James Jacob" },
        { role: "Student Coordinator", name: "Vishvaa" },
  ...
  },
  {
    ...
    details: {
      ...
      workshopHighlights: [
        "Hands-on experience with robotics and electronics",
        "Learn sensor integration using MPU6050 (gyroscope and accelerometer)",
        "Build a Bluetooth-controlled spinning robot",
        "Understand wireless communication protocols",
        "Explore motion control and sensor feedback systems",
        "Develop problem-solving and debugging skills",
        "Gain foundational knowledge in IoT and embedded systems",
      ],
      kitIncludes: [
        "Arduino-compatible microcontroller board",
        "Motor driver module (L298N or equivalent)",
        "DC motors (2x) with wheels",
        ...
        "Instruction manual and code templates",
      ],
      learningOutcomes: [
        "Understand the basics of robotics and sensor integration",
        "Learn how to program Arduino-based systems",
        "Implement Bluetooth-based wireless control",
        "Work with motion sensors (MPU6050) for gyroscope and accelerometer data",
        "Build a functional spinning robot with motion control",
        "Develop skills in electronics assembly and debugging",
        "Apply concepts in real-world IoT and automation projects",
      ],
      prerequisites: [
        "Basic understanding of electronics (not mandatory but helpful)",
        "Familiarity with programming concepts (Arduino IDE basics)",
        "Laptop with Arduino IDE installed",
        "Enthusiasm to learn and experiment!",
      ],
      whoShouldAttend: [
        "Engineering students interested in robotics and IoT",
        "Hobbyists looking to build real-world projects",
        "Anyone eager to explore sensor-based automation",
        "Students preparing for technical competitions or hackathons",
      ],
      eventTimeline: [
        { time: "9:00 AM - 9:30 AM", activity: "Registration & Welcome Session" },
        { time: "9:30 AM - 10:30 AM", activity: "Introduction to Robotics & Components Overview" },
        { time: "10:30 AM - 12:00 PM", activity: "Hands-On Assembly: Building the Spinabot" },
        { time: "12:00 PM - 1:00 PM", activity: "Lunch Break" },
        { time: "1:00 PM - 2:30 PM", activity: "Programming & Sensor Integration (MPU6050)" },
        { time: "2:30 PM - 4:00 PM", activity: "Bluetooth Connectivity & Testing" },
        { time: "4:00 PM - 4:30 PM", activity: "Q&A, Troubleshooting & Closing Ceremony" },
      ],
      rules: [
      ...
      whyAttend: [
        "Build a fully functional robot that you can take home",
        "Gain hands-on experience with cutting-edge robotics technology",
        "Learn from experienced mentors in the field of robotics and IoT",
        "Enhance your resume with practical robotics skills",
        "Network with like-minded tech enthusiasts",
        "Certificate of participation for all attendees",
      ],
      registrationInfo: {
        fee: "₹899 per participant (includes complete kit and materials)",
        deadline: "February 15, 2026",
        seatsAvailable: "Limited to 50 participants",
        note: "Early bird discount of ₹100 available until February 10, 2026",
      },
      contacts: [
