...
const Story = () => {
  ...
  return (
    <section
      id="story"
      className="min-h-dvh w-screen bg-slate-950 text-blue-50 overflow-y-hidden"
    >
        ...
        <div className="mt-10 md:-mt-40 flex w-full justify-center lg:-mt-80 md:me-44 md:justify-end">
          <div className="flex h-full w-fit flex-col items-center md:items-start">
            <p className="mt-3 max-w-sm text-center font-circular-web text-violet-50 md:text-start px-3">
              Join us in exploring groundbreaking research, connecting with
              industry leaders, and discovering the innovations that will define
            ...
            <Button
              ...
              onClick={() => {
                window.open(
                  "https://www.instagram.com/ozmenta_26",
                  "_blank",
                  "noopener,noreferrer"
                );
              }}
