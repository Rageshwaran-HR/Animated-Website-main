...
const Navbar = () => {
  ...
  const toggleAudioIndicator = async () => {
    ...
    const videoAudioOn =
      !!eventVideo && !eventVideo.paused && !eventVideo.muted && (eventVideo.volume ?? 1) > 0;
  ...
  return (
    <div ref={navContainerRef} className='floating-nav fixed inset-x-0 top-16 z-50 h-16 transition-all duration-700 sm:inset-x-6'>
